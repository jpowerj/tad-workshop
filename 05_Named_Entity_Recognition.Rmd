...
In this tutorial, we'll be talking about this final method, Named Entity Recognition. Unfortunately, because of 

```{r,init-api}
library(googleLanguageR)
gl_auth("~/gcloud_nlp/TL-NLP-e6110f370407.json")
